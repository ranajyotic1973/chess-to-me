...
- Name: board-analysis.spec.ts >> Chess Board - Move Input (Mouse & Keyboard) >> should reject illegal moves on the board
- Location: tests\integration\board-analysis.spec.ts:90:7
