...
- Name: redux-integration.spec.ts >> Redux Integration - Board Moves and Line Selection >> should update analysis state when selectEngineLine thunk completes
- Location: tests\integration\redux-integration.spec.ts:142:7
