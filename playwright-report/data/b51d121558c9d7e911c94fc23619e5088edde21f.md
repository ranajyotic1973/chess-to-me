...
- Name: board-analysis.spec.ts >> Engine Analysis - Lines Display >> should display 4 engine lines in analysis mode
- Location: tests\integration\board-analysis.spec.ts:131:7
