...
- Name: board-analysis.spec.ts >> Chess Board - Move Input (Mouse & Keyboard) >> should allow 10 moves for black via drag and drop
- Location: tests\integration\board-analysis.spec.ts:53:7
