...
- Name: board-analysis.spec.ts >> LLM Explanations >> should display LLM explanation when line is selected
- Location: tests\integration\board-analysis.spec.ts:250:7
