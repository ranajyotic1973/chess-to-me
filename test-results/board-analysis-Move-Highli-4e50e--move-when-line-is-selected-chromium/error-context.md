...
- Name: board-analysis.spec.ts >> Move Highlighting - Selected Line Navigation >> should highlight current move when line is selected
- Location: tests\integration\board-analysis.spec.ts:184:7
