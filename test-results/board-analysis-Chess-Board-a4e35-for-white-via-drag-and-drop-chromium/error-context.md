...
- Name: board-analysis.spec.ts >> Chess Board - Move Input (Mouse & Keyboard) >> should allow 10 moves for white via drag and drop
- Location: tests\integration\board-analysis.spec.ts:22:7
