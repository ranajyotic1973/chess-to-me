# opening-training-agent Specification

## Purpose
Interactive opening training agent for children (ages 4–18): teaches named openings with per-move commentary, ECO identification, and deep novelty-aware engine tuning.
